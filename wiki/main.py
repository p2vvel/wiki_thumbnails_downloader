...
if __name__ == "__main__":
    seb = "https://en.wikipedia.org/wiki/Sebastian_Vettel"
    season = 'https://en.wikipedia.org/wiki/1950_Formula_One_season'
    season = 'https://en.wikipedia.org/wiki/1951_Formula_One_season'
    season2 = 'https://en.wikipedia.org/wiki/1952_Formula_One_season'

    thumb = WikiArticle(season)
    print(thumb.api_url)